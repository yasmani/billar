...
<form name="formulario" target="_blank" action="reportes/reporte-compras-semanal.php"
                      ...
                      <!--div responsivo-->
                      <h1>REPORTE CONSOLIDADO  DE COMPRAS EN PDF</h1>
                           ...
                           <input  style="color:black"  type="date" id="inicio" name="inicio"
							  ...
							  value="<?php echo date("Y-m-d");?>">
								...
								<a href="exportar_ventas_xsl.php" target="_blank" rel="noopener noreferrer"> descargar en excel</a>
</form>	 
<form name="formulario" target="_blank" action="./exportar_compras_xsl.php"
                      id="formulario" method="POST">
                      <!--div responsivo-->
                      <h1>REPORTES DE CONSOLIDADO DE  COMPRAS EN EXCEL</h1>
                           <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h4>FECHA INICIO: &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; FECHA FINAL:</h4>
                           <input  style="color:black"  type="date" id="inicio" name="inicio"
                                 value="<?php echo date("Y-m-d");?>"

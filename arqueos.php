...
$sentencia = $base_de_datos->query("SELECT * FROM apertura where estado='1' order by id desc");
       ...
       name="meeting-time"  
		...
		<table style="color:white" name="tabla" class="table table-bordered">
			...
			<tbody>
				...
				<td><a class="btn btn-info" href="<?php echo "imprimir_arqueo.php?id=" . $venta->id."&fecha=".$venta->fecha?>"><i class="fa fa-print"></i></a></td>
				</tr>
				<?php 
				}
				?>

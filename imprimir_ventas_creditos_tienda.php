...
?>
	...
	<div class="col-xs-12">
		<h1>VENTAS AL CREDITO EN TIENDA</h1>
		<br>
		<label  style="color:white"> ver creditos por cliente</label> 
				 ...
				 <select    required name="cliente" class="form-control  "  data-live-search="true">
		...
		<table style="color:white" name="tabla" class="table table-bordered">
			...
			<tbody>
				...
				foreach($ventastienda as $venta){ 
					// if("0"=="0"){
					if($venta->tipoDeVenta=="2" && ($venta->total-$venta->saldo)>0 ){

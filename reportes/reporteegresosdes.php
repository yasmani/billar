...
$pdf->Cell(40,6,'',0,0,'C');
$pdf->Cell(100,6,'REPORTE DE PRODUCTOS DE BAJAS',1,1,'C'); 
$inicio=$_POST['inicio'];
$fin=$_POST['fin']; 
...
$pdf->Cell(80,6,'NOMBRE DEL PRODUCTO',1,0,'C',1);
$pdf->Cell(60,6,'CANTIDAD UNIT.',1,0,'C',1); 
...
require_once "../modelos/Egresosdes.php";
...
$pdf->SetWidths(array(80,60,20,20));
$monto_total=0;
...
{  
  ...
  $pdf->Row(array(utf8_decode($nombre),utf8_decode($cantidad),utf8_decode($total)." bs.",utf8_decode($total)." bs."));
}
$pdf->SetX(150);

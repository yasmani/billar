...
<br>   
			...
			<div   class="col-lg-12">
				...
				<select style="color:black" name="tipoDeVenta" class="form-control selectpicker">
					<option  style="color:black"value="1">CONTADO</option>
					<option style="color:black" value="2" selected>CRETIDO</option>
				</select>
...
function actualizarTotal(){
		document.getElementById('monto_con_descuento').value = parseInt(document.getElementById("montito").value)- parseInt(this.value);
		document.getElementById('monto_con_descuento2').value = parseInt(document.getElementById("montito").value)- parseInt(this.value);
}
function SUMA(){
  var X=0;
  var total=0;

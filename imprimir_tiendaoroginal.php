...
//   $pdf->Image('./files/logo/logotiro.png',6,6,60,38,'png');
// $pdf->Ln(40);
$pdf->setX(12);
//$pdf->Cell(40,10,"        ",0,1,"L");
$pdf->setX(10);
    $pdf->Cell(40,10,utf8_decode("    LA BUCHACA"),0,1,"L");
    $pdf->setX(25);
 ...
 $pdf->setX(20);
      //$pdf->Cell(40,10," ",0,1,"L");
          $pdf->SetFont('Helvetica','',10);
           ...
           //$pdf->Ln(15);
 $pdf->setX(5);
     $pdf->Cell(40,5,utf8_decode("Cel:76928396    "),0,1,"L");
     $pdf->setX(5);
     $pdf->Cell(40,5,utf8_decode("Dir:  Simon Lopez y Jaime Freire"),0,1,"L");
     ...
     // $pdf->Cell(40,5,utf8_decode("Patio de Comidas 1er Piso "),0,1,"L");
      ...
      $pdf->setX(5);
      //$pdf->Cell(40,5,utf8_decode("Celular:63461447"),0,1,"L");
...
foreach($productos as $producto){
   ...
   if(strlen($producto->nombre)>1){
     ...
     // $pdf->setX(48);
      ...
      $pdf->setX(58);
      $pdf->Cell(11,8, number_format(($producto->precioVenta*$producto->cantidad)- $producto->descuento,2,".",",") ,0,1,"L");
   }else{
      $pdf->SetFont('Courier','B',10);
      $pdf->setY($pdf->getY()+2);
      $pdf->setX(5);
...
$pdf->setX(68);
//$pdf->setY($pdf->getY()-8);
$pdf->Cell(5,4,number_format($total,1,".",",")."bs.",0,1,"R");
$pdf->Ln(3);
...
$pdf->Ln(5);
$pdf->setX(10);
$pdf->Cell(5,5,'  GRACIAS POR SU COMPRA',0,1,"L");

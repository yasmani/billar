...
?></div>
  ...
  <div class="col-md-12">
			...
			<input class="form-control" type="text" name="caja_busqueda_tienda" id="caja_busqueda_tienda"></input>
			<div id="datos"></div>
	</div>
</div>
		<br><br>
		<table style="color:black" name="tabla" class="table table-bordered">
			<thead style="color:white " name="tabla" class="table table-darger">
				<tr style="background-color: blue">	 
					...
					<th style='background-color:yellow;color:black'>PRECIO VENTA </th>
			...
			<tbody>
				...
				<tr>
					...
					<td  >
					<!--  precio compra -->
					<form action="./aumentarPrecioCompraTienda.php" method="post">
					...
					<td>
					<form action="./aumentarPrecioVentaTienda.php" method="post">
					<input name="compras" value="compras" type="hidden">
					<input name="codigo" value="<?php echo $producto->codigo?>" type="hidden">
					<input name="indice" value="<?php echo $indice?>" type="hidden">
					...
					<form action="./aumentarPrecioVenta2Tienda.php" method="post">
					<input name="compras" value="compras" type="hidden">
					<input name="codigo" value="<?php echo $producto->codigo?>" type="hidden">
					<input name="indice" value="<?php echo $indice?>" type="hidden">
					...
					<td style="display:none" >
					<form action="./aumentarPrecioVenta3Tienda.php" method="post">
					<input name="compras" value="compras" type="hidden">
					<input name="codigo" value="<?php echo $producto->codigo?>" type="hidden">
					<input name="indice" value="<?php echo $indice?>" type="hidden">
					...
					<td>
					<form action="./aumentarCantidadComprasTienda.php?" method="post">
					<input name="compras" value="compras" type="hidden">
					<input name="codigo" value="<?php echo $producto->codigo?>" type="hidden">
					<input name="indice" value="<?php echo $indice?>" type="hidden">
					...
					<!-- quitar del carrito -->
					<td><a  class="btn btn-danger" href="<?php echo "quitarDelCarritoComprasTienda.php?indice=" . $indice?>"><i class="fa fa-trash"></i></a></td>
				</tr>
				<?php } ?>  
				
			</tbody>
		</table>
		<h2> <?php echo "cant ".$cant ?></h2>
		...
		<form action="./terminarCompraTienda.php" method="POST">
		<select style="display:none" name="proveedor" class="form-control selectpicker" id="select-country" data-live-search="true">

<?php
  ...
  $password = "MO!&aP9::~d3";
$username = "u269279962_ubuchaca";
$dbname = "u269279962_dbbucahca";
         ...
         $salida.="<tr>
             ...
             <td>".$fila['tienda']."</td>
              ...
              <td>  
                ...
                <form method='post' action='agregarAlCarrito_traspaso.php'>
                ...
                <form method='post' action='agregarAlCarrito_traspaso.php'>
                     ...
                     <div class='col col-lg-3'>
                       ...
                       <input name='precio'  min='".$fila['precioVenta']."' max='".$fila['precioVenta3']."'  style='color:black;width:60px' type='number' step='0.01' value='".$fila['precioVenta2']."'>
                      </div>
                     <div class='col col-lg-4'>

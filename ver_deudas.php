...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4/js/i18n/defaults-*.min.js"></script>
	<div style="background-color: #162656;" class="col-xs-12">
		<h1>CREDITOS POR CLIENTE</h1>
		<br>
		<label  style="color:white"> ver creditos por cliente</label> 
 				<form action="ver_deudas.php" method="get">
		...
		<table style="color:white" name="tabla" class="table table-bordered">
			...
			<tbody>
				...
				foreach($ventastienda as $venta){ 
					...
					if($venta->tipoDeVenta=="2"   && $venta->cliente==$codigo_cliente ){
				...
				<tr> 
					...
					<td style="color:yellow;font-size:20px" ><?php echo $nombre_cliente ?></td>

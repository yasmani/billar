...
<body style="margin-rigth:-150px;margin-left:-150px; background-color:WHITE ;color:black">
	<nav  style="background-color:green;color:black" class="navbar navbar-inverse navbar-fixed-top">
		<div  style="margin-left:20px;pading-right:100px" class=" ">
			...
			<div   id="navbar" class="collapse navbar-collapse">
				...
				<ul  class="nav navbar-nav">
					...
					<!-- <li><a href="./formularioR.php">registrar</a></li> -->
					  ...
					  <li><a style="color:white"  > <b>BILLAR CABRERA </b></a></li>  
					   <li><a style="color:white;font-size:12PX;border:white 1px solid"  > <b> USUARIO :  <?PHP echo $_COOKIE["usuario"];?></b></a></li>  
					<?php 	 
						if(1==1){
						   // echo ' <li><a style="color:yellow;font-size:12PX;border:white 1px solid" href="./usuarios.php"> <b> Usuarios</b></a></li>';
						    //echo '<li><a style="color:yellow;font-size:12PX;border:white 1px solid" href="./listar-inventario_tienda.php">Inventario</a></li>';
						   // echo '<li><a style="color:yellow;font-size:15PX;border:white 1px solid" href="./traspaso.php">TRASPASO</a></li>';
						    //echo '<li><a style="color:yellow;font-size:15PX;border:white 1px solid" href="./imprimir_traspaso.php">impTraspaso</a></li>';
						    //echo '<li><a style="color:yellow;font-size:12PX;border:white 1px solid" href="./comprasTienda.php">Compras</a></li>';
						    //echo '<li><a style="color:yellow;font-size:12PX;border:white 1px solid" href="./imprimir_compras_tienda.php">Imp.Comp</a></li>';
						     
						      
							
							
							//echo '<li><a style="color:black;font-size:12PX;border:white 1px solid" href="./listar-inventario_tienda.php">Inventario</a></li>';
				...
				// 			echo '<li><a style="background-color:orange;color:black;font-size:12PX;border:white 1px solid" href="./venderTienda.php">VENDER </a></li>';
							...
							<li><a style="color:white;font-size:15PX;border:white 1px solid"href="./cambio.php">fraccionamiento</a></li>
							';
							...
							//echo '<li><a style="color:yellow;font-size:15PX;border:white 1px solid"href="./imprimir_ventas_creditos_tienda.php">Cred.</a></li>';
							//echo '<li><a style="color:yellow;font-size:12PX;border:white 1px solid"href="./listar.php">ADM</a></li>
							//<li><a style="color:yellow;font-size:15PX;border:white 1px solid"href="./egresoadm.php">Gastos</a></li>
							        //';
						}else{
						}
						?>	
			...
			if($existe!=null){
				echo ' <button  style="color:white; margin-left:5px; " type="button" class="btn btn-success btn-sx" data-toggle="modal" data-target="#myModal">Cerrar Caja </button>  ';
			}else{
				echo ' <button  style="color:white;margin-left:5px;" type="button" class="btn btn-success btn-sx" data-toggle="modal" data-target="#myModal">Abrir Caja  </button>  ';
			}
			$usuario=$_COOKIE["id"];
			...
			foreach($atencion as $m){ 
				$idmesa=$m->idmesa;
			//	echo '<button  style="color:white;background-color:#4a80c6;" type="button" class="btn btn-success btn-lg" data-toggle="modal"  > MESA '.$m->idmesa.'  </button>';
			...
			echo '<button  style="color:black;margin-left:5px; margin-top:2px;" type="button" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#por_cobrar"  > por cobrar '.$monto.'  </button> ';
			...
			echo '<button  style="color:white;background-color:#232f48;margin-left:5px; margin-top:2px;" type="button" class="btn btn-success btn-lg" data-toggle="modal"  > TOTAL '.$montoV.'  </button>';
		?></li> 
				</ul>
			</div>
		</div>
      ...
      <div class="modal-content">
		...
		<?php 
			...
			if($existe!=null){
				...
				<textarea required id="cajero" name="cajero" cols="2" rows="1" class="form-control"> '.$_COOKIE["usuario"].'</textarea>

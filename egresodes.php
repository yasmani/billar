...
<div class="col-xs-12">
	<h1>PRODUCTOS DE BAJAS</h1>
	<form method="post" enctype="multipart/form-data" action="EgresoControllerdes.php" >
		<label for="codigo">NOMBRE DEL PRODUCTO DE BAJAS:</label>
		<input class="form-control" name="nombre"  required type="text" id="nombre" placeholder="Escribe nombre">
		<label for="cantidad">CANTIDAD DE PRODUCTO DE BAJAS :</label>
		...
		<label for="precioCompra">PRECIO DE PRODUCTOS DE BAJAS:</label>
